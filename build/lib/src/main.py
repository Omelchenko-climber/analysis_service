from src.utils import ErrorAnalyseService, NotifyService, EmailOutput, ConsoleOutput, TelegrambotOutput, HtmlOutput
...
def run():
    ...
    get_result: str = input('How do you want to get the result? (email, telegrambot, console, htmlfile): ')
    get_result = check_input(get_result, ['email', 'telegrambot', 'console', 'htmlfile'])
